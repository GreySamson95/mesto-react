      ...
      <main className="content">
        ...
        <PopupWithForm name="edit-profile" title="Редактировать профиль" buttonCaption='Cохранить' isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>
          <>
            ...
            <label className="popup__field">
              <input type="text" placeholder="О себе" className="popup__input popup__input_about" name="about" minLength="2" maxLength="200" id="about-input" required></input>
        ...
        <PopupWithForm name="add-photo" title="Новое место" buttonCaption='Cохранить' isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
          <>
            ...
            <label className="popup__field">
              <input type="url" placeholder="Ссылка на картинку" className="popup__input popup__input_link" name="link" id="link-input" required></input>
